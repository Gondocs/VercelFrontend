  ...
  return (
    <main className="py-16">
      <section className="w-[70%] mx-auto bg-black">
        ...
        <div className="bg-black text-white rounded-xl my-4 p-6 shadow-lg animate-slide-in-up">
          <h2 className="text-xl font-bold text-white animate-slide-in-left mb-2">Online Oktatási Platform</h2>
          <p className="text-white mb-4 animate-slide-in-right">
        ...
        <div className="bg-black text-white rounded-xl my-4 p-6 shadow-lg animate-slide-in-up">
          <h2 className="text-xl font-bold text-white animate-slide-in-left mb-2">Időmenedzsment Alkalmazás</h2>
          <p className="text-white mb-4 animate-slide-in-right">
        ...
        <div className="bg-black text-white rounded-xl my-4 p-6 shadow-lg animate-slide-in-up">
          <h2 className="text-xl font-bold text-white animate-slide-in-left mb-2">E-commerce Weboldal</h2>
          <p className="text-white mb-4 animate-slide-in-right">
