...
export default function Home() {
  ...
  return (
    <main className="py-12 bg-gradient-to-b from-black to-black min-h-screen">
      <section className="w-[75%] max-w-5xl mx-auto bg-black rounded-2xl shadow-2xl p-10 mb-10 border border-black animate-slide-in-up">
      ...
      <section className="w-[75%] max-w-5xl mx-auto bg-black rounded-2xl shadow-2xl p-10 flex flex-col md:flex-row items-center gap-10 border border-black animate-slide-in-up">
